...
// Wadefak Men
const fmen = { key : { participant : '0@s.whatsapp.net'}, message: {orderMessage: {itemCount : 2021, status: 1, surface : 1, message: `© LynBotz`, thumbnail: fs.readFileSync('./src/Mufar.jpg'), sellerJid: '0@s.whatsapp.net'}}}
const fdoc = { key: { participant : '0@s.whatsapp.net'}, message: {documentMessage: {title: `© LynBotz Official`, jpegThumbnail: thumb}}}
...
const fgif = { key: { participant: '0@s.whatsapp.net', ...(from ? { remoteJid: "6283871990243-1613049930@g.us" } : {})}, message: {"videoMessage": { "title":`© LynBotz`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `© LynBotz`, 'jpegThumbnail': thumb}}}
const fgclink = { key: { participant: '0@s.whatsapp.net', "remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6283871990243-1616169743@g.us","inviteCode": "m","groupName": "LynBotz", "caption": `© LynBotz`, 'jpegThumbnail': thumb}}}
const fvideo = { key: { fromMe: false, participant: '0@s.whatsapp.net', ...(from ? { remoteJid: "6283871990243-1613049930@g.us" } : {})}, message: { "videoMessage": { "title":`© LynBotz`, "h": `Hmm`,'seconds': '99999', 'caption': `© LynBotz`, 'jpegThumbnail': thumb}}}
const floc = { key: { participant : '0@s.whatsapp.net'}, message: {locationMessage: {name: `© LynBotz`, jpegThumbnail: thumbz}}}
const fakevo = { key: { fromMe: false, participant: '0@s.whatsapp.net', remoteJid: 'status@broadcast'}, message: {imageMessage: {mimetype: 'image/jpeg', caption: 'LynBotz', jpegThumbnail: fs.readFileSync('./src/Mufar.jpg'), viewOnce: true}}}
...
{ buttonId: `${prefix}owner`, buttonText: { displayText: 'Creator LynBotz' }, type: 1 }
]
...
gbutsan = [
{buttonId:`owner`, buttonText:{displayText: 'Creator LynBotz'}, type:1},
...
footerText: '*_© Lyn - Official Bot_*',
description: `${tampilUcapan} ${pushname}, *Hallo User @${sender.split('@')[0]}, Silahkan pilih menu Lyn-Botz disini*`,
sections: [
                 {
                 "title": `${week}, ${calender}`,
 rows: [
...
case 'rulesbot':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
ruls =`*Syarat & Ketentuan LynBotz.ೃ🐣*
...
*Silahkan lanjut gunakan LynBotz!*`
...
members_ids.push(mem.jid)
            ...
            replyWithFakeLink('*Ini Nomor Owner LynBotz*\nMau Chat? Utamakan Salam!')
            limitAdd(sender, limit)
            break
